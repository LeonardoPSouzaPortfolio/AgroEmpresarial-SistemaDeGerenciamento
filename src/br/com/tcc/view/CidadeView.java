...
public class CidadeView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, cidadeList, tblObjetos);
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        cidadeList.add((Cidade) new Cidade());
        int row = cidadeList.size() - 1;
    ...
    private void btnGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGravarActionPerformed
        if (validaCampos()) {
            try {
                ...
                Cidade obj = cidadeList.get(linhaClicada);
...
//        atualizaGrid();
    ...
    private void txtDescricaoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDescricaoKeyReleased
        cidadeQuery = entityManager.createNamedQuery("Cidade.findByNome");
                cidadeQuery.setParameter("nome", txtDescricao.getText());
                List<Cidade> verifica = cidadeQuery.getResultList();
                if (verifica.size() > 0) {
    ...
    private void atualizaGrid() {
        ...
        if (filtro.length() > 0 && filtro != null) {
            sql += " where upper(c." + ordem + ") like '" + filtro.toUpperCase() + "%' ";
        }
//        sql += " order by " + "p.id desc";
        sql += " order by c." + ordem;
        System.out.println("SQL Gerado: " + sql);
        cidadeQuery = entityManager.createQuery(sql);
        cidadeList.clear();
