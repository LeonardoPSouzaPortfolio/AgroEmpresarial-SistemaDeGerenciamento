...
import br.com.tcc.entity.Tipofornecedor;
 ...
 * @author Leonardo
 */
public class TipoFornecedorView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tipoFornecedorQuery = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT f FROM Tipofornecedor f");
        ...
        setTitle("Manutenção de Tipos de Fornecedor");
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tipofornecedorList, tblObjetos);
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        tipofornecedorList.add((Tipofornecedor) new Tipofornecedor());
        int row = tipofornecedorList.size() - 1;
    ...
    private void btnGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGravarActionPerformed
        if (validaCampos()) {
            try {
                ...
                Tipofornecedor obj = tipofornecedorList.get(linhaClicada);
...
//        atualizaGrid();
    ...
    private void txtDescricaoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDescricaoKeyReleased
        tipoFornecedorQuery = entityManager.createNamedQuery("Tipofornecedor.findByDescricao");
                tipoFornecedorQuery.setParameter("descricao", txtDescricao.getText());
                List<Tipofornecedor> verifica = tipoFornecedorQuery.getResultList();
                if (verifica.size() > 0) {
    ...
    private void atualizaGrid() {
        String sql = "from Tipofornecedor f";
        String ordem = "";
        ...
        if (filtro.length() > 0 && filtro != null) {
            sql += " where upper(f." + ordem + ") like '" + filtro.toUpperCase() + "%' ";
        }
//        sql += " order by " + "p.id desc";
        sql += " order by f." + ordem;
        System.out.println("SQL Gerado: " + sql);
        tipoFornecedorQuery = entityManager.createQuery(sql);
        tipofornecedorList.clear();
        tipofornecedorList.addAll(tipoFornecedorQuery.getResultList());
        int row = tipofornecedorList.size() - 1;
        if (row >= 0) {
        tblObjetos.setRowSelectionInterval(row, row);
