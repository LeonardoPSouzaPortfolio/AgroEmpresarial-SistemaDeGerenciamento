...
import br.com.tcc.entity.Funcao;
...
public class FuncaoView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Manutenção de Funções de Funcionário");
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, funcaoList, tblObjetos);
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        funcaoList.add((Funcao) new Funcao());
        int row = funcaoList.size() - 1;
    ...
    private void btnGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGravarActionPerformed
        if (validaCampos()) {
            try {
                ...
                Funcao obj = funcaoList.get(linhaClicada);
...
//        atualizaGrid();
    ...
    private void txtDescricaoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDescricaoKeyReleased
        funcaoQuery = entityManager.createNamedQuery("Funcao.findByNome");
                funcaoQuery.setParameter("nome", txtDescricao.getText());
                List<Funcao> verifica = funcaoQuery.getResultList();
                if (verifica.size() > 0) {
...
//        sql += " order by " + "p.id desc";
        ...
        funcaoQuery = entityManager.createQuery(sql);
        funcaoList.clear();
        funcaoList.addAll(funcaoQuery.getResultList());
        int row = funcaoList.size() - 1;
        if (row >= 0) {
        tblObjetos.setRowSelectionInterval(row, row);
