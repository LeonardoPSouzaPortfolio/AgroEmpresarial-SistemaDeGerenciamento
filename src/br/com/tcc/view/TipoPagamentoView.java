...
public class TipoPagamentoView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tipoPagamentoQuery = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT f FROM Tipopagamento f");
        ...
        setTitle("Manutenção de Tipos de Pagamento");
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tipoPagamentoList, tblObjetos);
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        tipoPagamentoList.add((Tipopagamento) new Tipopagamento());
        int row = tipoPagamentoList.size() - 1;
    ...
    private void btnGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGravarActionPerformed
        if (validaCampos()) {
            try {
                ...
                Tipopagamento obj = tipoPagamentoList.get(linhaClicada);
...
//        atualizaGrid();
    ...
    private void txtDescricaoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDescricaoKeyReleased
        tipoPagamentoQuery = entityManager.createNamedQuery("Tipofornecedor.findByDescricao");
                tipoPagamentoQuery.setParameter("descricao", txtDescricao.getText());
                List<Tipopagamento> verifica = tipoPagamentoQuery.getResultList();
                if (verifica.size() > 0) {
    ...
    private void atualizaGrid() {
        String sql = "from Tipopagamento f";
        String ordem = "";
...
//        sql += " order by " + "p.id desc";
        ...
        tipoPagamentoQuery = entityManager.createQuery(sql);
        tipoPagamentoList.clear();
        tipoPagamentoList.addAll(tipoPagamentoQuery.getResultList());
        int row = tipoPagamentoList.size() - 1;
        if (row >= 0) {
        tblObjetos.setRowSelectionInterval(row, row);
